                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12">
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div class="row mb-3" style="position: absolute; right:35px; z-index:1;">
                                        <label class="m-0 ml-2 mr-2 col-form-label">Bulan</label>
                                        <input id="blnbl" type="month" onchange="bulanBL()">
                                    </div>
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="tabelPemasukan" width="100%"
                                            cellspacing="0">
                                            <thead>
                                                <tr>
                                                    <th scope="col">No</th>
...
$no = 1;
    ...
    foreach ($sql as $key):
        ...
        ;?>
                                                    ...
                                                    <?php if ($key['ID_KT'] == "0") {?>
                                                    <!-- //jika Anggota -->
                                                    <td style="background-color: #f5f3f2">
                                                        <?=$key['ID_AKT'] . " (Anggota)";?></td>
                                                    <?php } else {?>
                                                    <!-- //jika Kelompok -->
...
$toatalPemasukan = mysqli_query($conn, "SELECT sum(Total) as totalPemasukan FROM penjualan");
    ...
    ?>
                                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                                <?=rp($toatalPemasukannya);?></div>
                                                        </div>
                                                        <div class="col-auto">
                                                            <i class="fas fa-coins fa-2x text-success"></i>
                                                        </div>
                                                        <div class="mt-3 text-muted" style="font-size: 0.875em;">total
                                                            pemasukan adalah total dari
                                                            semua
                                                            penjualan
                                                ...
                                                <div class="card-body">
                                                    <div class="row no-gutters align-items-center">
                                                        <div class="col mr-2">
                                                            ...
                                                            <div class="mt-3 text-muted" style="font-size: 0.875em;">
                                                                penghasilan bersih dari penjualan
                                                                dikurangi pembelian pupuk / bulan (jika di set bulannya)
                                                            </div>
                                                        </div>
                                                        <div class="col-auto">
                                                            <div class="col-md-3"><img src="img/money-bag.png"
                                                                    width="50%"></div>
                                                        </div>
