...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion mt-5 " id="accordionSidebar">
  ...
  <!-- Nav Item - Pages Collapse Menu -->
  <li <?php if ($_GET['m'] == 8 && $_GET['n'] == 8) {echo "class='nav-item active'";} else {echo "class='nav-item'";}?>>
    <a class="nav-link" href="page_pengeluaran.php?m=8&n=8">
      <i class="fas fa-money-bill-wave"></i>
      <span>Pengeluaran</span></a>
  </li>
  <li <?php if ($_GET['m'] == 9 && $_GET['n'] == 9) {echo "class='nav-item active'";} else {echo "class='nav-item'";}?>>
