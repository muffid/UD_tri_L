                ...
                <div class="card-body">
                  ...
                  <form method="POST" action="addStokMasuk.php" enctype="multipart/form-data">
                    ...
                    <div class="row mb-2">
                      ...
                      <div class="col-sm-8">
                        <input type="text" class="form-control" id="pengirim" name="pengirim" required
                          onkeyup="SETis()">
                        <input type="text" class="form-control" id="idppk" name="idppk" required hidden>
                    ...
                    <div class="row mb-4">
                      ...
                      <div class="col-sm-8">
                        <select class="custom-select" id="jenisPP" name="jenisPP" onchange="SETPP()">
                          ...
                          <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-footer">
                                ...
                                <a href="deleteDataPupuk.php?id=<?=$all['ID_SM'];?>" class="btn btn-danger">Ya,
                                  Batalkan</a>
                              </div>
                            </div>
                          </div>
