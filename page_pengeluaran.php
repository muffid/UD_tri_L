            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between ">
                        <h1 class="h3 mb-3 text-gray-800">Pengeluaran</h1>
...
$nobl = 1;
    ...
    $totalbl = 0;
    if (isset($_GET['BT'])) {
        $sqlbl = mysqli_query($conn, "SELECT * FROM biaya_lain WHERE Tanggal LIKE '%" . $_GET['BT'] . "%' ORDER BY ID_BL DESC");
    } else {
    ...
    if ($key['ID_SM'] == 0) {?>
        ...
        ;?>
                                                    ...
                                                    <td> <?="Transport Pengiriman Pupuk ke " . $keyjual['ID_AKT'] . " (anggota)";?>
                                                    </td>
                                                    <?php } else {;?>
            ...
            ?>
                                                    <td> <?="Transport Pengiriman Pupuk ke kelompok tani " . $keykel['Nama_Kel'];?>
                                                    </td>
                                                    <?php }
        ;?>
