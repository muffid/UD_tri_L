                ...
                <div class="card-body">
                  <center>
                    <a>
                      ...
                      <img class='img-profile rounded-circle w-50 mt-3' src='img/<?php echo $foto; ?>'>
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <ul class="nav nav-pills mb-1" id="pills-tab" role="tablist">
                    <li class="nav-item" role="presentation">
                      <a class="nav-link active" id="profil-tab" data-toggle="pill" href="#profil" role="tab"
                    ...
                    <li class="nav-item" role="presentation">
                      <a class="nav-link" id="edit-profile-tab" data-toggle="pill" href="#edit-profile" role="tab"
                        aria-controls="edit-profile" aria-selected="false">Edit Profil</a>
                    </li>
                    <li class="nav-item" role="presentation">
                      <a class="nav-link" id="ganti-Pass-tab" data-toggle="pill" href="#ganti-Pass" role="tab"
                        aria-controls="ganti-Pass" aria-selected="false">Ganti Username & Password</a>
                    </li>
                  </ul>
                </div>
                <div class=" card-body">
                  <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="tab-pane fade" id="edit-profile" role="tabpanel" aria-labelledby="edit-profile-tab">
                      ...
                      function hapus() {
                        ...
                        document.getElementById("uploadPreview").style.height = '0px';
                      ...
                      <form method="POST" action="insert_user.php" enctype="multipart/form-data">
                        ...
                        <div class="row mb-6">
                          ...
                          <div class="col-md-6 col-lg-6">
                            ...
                            <img class="mb-2 float-left" id="uploadPreview">

                            <div class="input-group mb-3">
                              <input type="file" id="Gambar" name="Gambar"
                                class="form-control btn btn-outline-primary btn-sm " onchange="PreviewImage();">
                        ...
                        <div class="row mb-6">
                          <label for="TentangPer" class="col-md-4 col-lg-3 col-form-label">Tentang
                            Perusahaan</label>
                          <div class="col-md-8 col-lg-9">
                            <textarea name="TentangPer" id="TentangPer" style="height: 100px" class="form-control"
                        ...
                        <div class="row mb-6">
                          <label for="NamaPer" class="col-md-4 col-lg-3 col-form-label">Nama
                            Perusahaan</label>
                          <div class="col-md-8 col-lg-9">
                            <input name="NamaPer" type="text" class="form-control" id="NamaPer"
                              value="<?php echo ($_SESSION['per']); ?>" onkeypress="enbld()">
                            <br>
                          </div>
                        </div>
                        <div class="row mb-6">
                          ...
                          <div class="col-md-8 col-lg-9">
                            <input name="Admin" type="text" class="form-control" id="Admin"
                              value="<?php echo ($_SESSION['nama']); ?>" onkeypress="enbld()">
                            <br>
                          </div>
                        </div>
                        <div class="row mb-6">
                          ...
                          <div class="col-md-8 col-lg-9">
                            <input name="status" type="text" class="form-control" id="status"
                              value="<?php echo ($_SESSION['job']); ?>" onkeypress="enbld()">
                            <br>
                          </div>
                        </div>
                        <div class="row mb-6">
                        ...
                        <div class="row mb-6">
                          ...
                          <div class="col-md-8 col-lg-9">
                            <input name="noTelp" type="text" class="form-control" id="noTelp"
                              value="<?php echo ($_SESSION['no_telp']); ?>" onkeypress="enbld()">
                            <br>


                            <button id="rubahGambar" type="submit" name="rubahGambar" class="btn btn-primary">Simpan
                              Perubahan</button>
                          </div>
                        </div>
                    ...
                    <div class="tab-pane fade" id="ganti-Pass" role="tabpanel" aria-labelledby="ganti-Pass-tab">
                        ...
                        <div class="row mb-6">
                          ...
                          <div class="col-md-8 col-lg-9">
                            <input name="User" type="text" class="form-control" id="User"
                              value="<?php echo ($_SESSION['UserName']); ?>" onkeypress="enbld()"> <br>
                          </div>
                        </div>
                        <div class="row mb-6">
                          <label for="PassBaru" class="col-md-4 col-lg-3 col-form-label">Password Baru</label>
                          <div class="col-md-8 col-lg-9">
                            <input name="PassBaru" type="password" class="form-control" id="PassBaru" value=""
                              onkeypress="enbld()"> <br>
                          </div>
                        </div>
                        <div class="row mb-6">
                          <label for="KonPass" class="col-md-4 col-lg-3 col-form-label">Konfrimasi
                            Password</label>
                          <div class="col-md-8 col-lg-9">
                            <input name="KonPass" type="password" class="form-control" id="KonPass" value=""
                              onkeypress="enbld()">
                            <br>
                            <button id="ubahPass" type="submit" name="ubahPass" class="btn btn-primary">Simpan
                              Perubahan</button>
                          </div>
                        </div>
                      </form>
