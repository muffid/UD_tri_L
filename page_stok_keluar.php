            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between ">
                        ...
                        <h1 class="h3 mb-3 text-gray-800">Penjualan Pupuk</h1>
    ...
    ?>
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-cart-plus"></i> Input
                                        Penjualan Pupuk
                                    </h6>
                                    ...
                                    <div class="row mb-2 mt-3">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="custom-control custom-radio custom-control-inline"
                                                onclick="kelompokCtrl()">
                                                <input type="radio" id="customRadioInline1" name="customRadioInline1"
                                                    class="custom-control-input" checked>
                                                <label class="custom-control-label"
                                                    for="customRadioInline1">Kelompok</label>
                                            </div>
                                            <div class="custom-control custom-radio custom-control-inline"
                                                onclick="anggotaCtrl()">
                                                ...
                                                <label class="custom-control-label"
                                                    for="customRadioInline2">Anggota</label>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-2" id="divKel">
                                        ...
                                        <div class="col-sm-8">
                                            <select class="custom-select" id="selectcust" onclick="custControl()">
                                                <option value="nocust" selected="true" disabled="disabled">-- pilih
                                                    kelompok tani --
                                                </option>
                                                <?php
$data = mysqli_query($conn, "SELECT ID_KT,Nama_Kel FROM data_kel_tani ORDER BY ID_KT DESC");
    ...
    ?>
                                    ...
                                    <div class="row mb-4" id="divAng">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="anggota" name="anggota"
                                                onkeyup="setNamaAnggota()" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-8">
                                            <select class="custom-select" id="selectpupuk" name="selectpupuk"
                                                onchange="pupukControl()" required>
                                                <option value="nopuk" selected="true" disabled="disabled">-- pilih jenis
                                                    pupuk --
                                                </option>
                                                <?php
$data = mysqli_query($conn, "SELECT ID_PK,Jenis_Pupuk,Harga,Stok FROM data_pupuk ORDER BY ID_PK DESC");
    ...
    ?>
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="number" class="form-control" id="jumlah" name="jumlah"
                                                onkeyup="stokAvailCheck()" required)>
                                    ...
                                    <div class="row mb-4">
                                        ...
                                        <div class="col-sm-6">
                                            <button type="button" id="btnOK" class="btn btn-primary btn-sm"
                                                onclick="addFields()"><i class="fas fa-plus-square"></i>
                                                tambahkan</button>
                                        </div>
                                    </div>
                        ...
                        <div class="col-xl-6 col-lg-6">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-file"></i> Nota
                                        Penjualan</h6>
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-sm-5">
                                                ...
                                                <input type="text" class="form-control" id="idpupuk" name="idpupuk"
                                                    hidden>
                                                <input type="text" class="form-control" id="idkel" name="idkel" required
                                                    hidden>
                                            ...
                                            <div class="col-sm-3 mt-1">
                                                <button type="button" class="btn btn-success btn-sm"
                                                    onclick="hitungTotal()"><i class="fas fa-coins"></i>
                                                    totalkan</button>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row mt-2 mb-2" id="row">
                                            ...
                                            <div class="col-sm-3">
                                                <button type="submit" class="btn btn-primary btn-sm" id="btnSubmit"
                                                    disabled><i class="fas fa-save"></i> simpan</button>
                                            </div>
                    ...
                    <div class="row">
                        <div class="col col-lg-12">
                            <div class="card shadow mb-4">
                                <div
                                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary"> <i class="fas fa-user"></i> Data
                                        Penjualan Pupuk -
                                    ...
                                    <div class="row mb-2">
                                        <div class="col col-lg-12">
                                            <div class="table-responsive">
                                                <table class="table table-bordered" id="tableKel" width="100%"
                                                    cellspacing="0">
                                                    <thead>
                                                        <tr>
                                                            <th scope="col">No</th>
...
$tgl = substr($tanggal, 6);
    ...
    foreach ($sqlPenj as $sp) {
        ...
        ?>
                                                        ...
                                                        <div class="modal fade" id="viewItemK<?=$sp['ID_PJ'];?>"
...
$getItem = mysqli_query($conn, "SELECT ID_PK,Jumlah_Keluar,Harga FROM stok_keluar WHERE key_transaksi LIKE '" . $sp['ID_KEY'] . "'");
        ...
        ?>
                                                        ...
                                                        <div class="modal fade" id="delItemK<?=$sp['ID_PJ'];?>"
                                                            tabindex="-1" role="dialog"
                                                            aria-labelledby="exampleModalCenterTitle"
                                                            aria-hidden="true">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <div class="container">
                                                                            <center>
                                                                                ...
                                                                                Membatalkan/ menghapus data Penjualan
                                                                                kepada kelompok tani <?=$namakelompok;?>
                                                                                mungkin akan
                                                                                menyebabkan beberapa data tidak
                                                                                singkron.
                    ...
                    <div class="row">
                        <div class="col col-lg-12">
                            <div class="card shadow mb-4">
                                <div
                                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-user-friends"></i>
                                ...
                                <div class="card-body">
                                    <div class="row mb-2">
                                        <div class="col col-lg-12">
                                            <div class="table-responsive">
                                                <table class="table table-bordered" id="tableAng" width="100%"
                                                    cellspacing="0">
                                                    <thead>
                                                        <tr>
                                                            <th scope="col">No</th>
...
$nopen = 1;
    ...
    foreach ($sqlPenj as $sp) {
        ...
        ?>
                                                        ...
                                                        <div class="modal fade" id="viewItem<?=$sp['ID_PJ'];?>"
                                                            tabindex="-1" role="dialog"
                                                            aria-labelledby="exampleModalCenterTitle"
                                                            aria-hidden="true">
                                                            <div class="modal-dialog modal-lg" role="document">
...
$getItem = mysqli_query($conn, "SELECT ID_PK,Jumlah_Keluar,Harga FROM stok_keluar WHERE key_transaksi LIKE '" . $sp['ID_KEY'] . "'");
        ...
        ?>
                                                        ...
                                                        <div class="modal fade" id="delItem<?=$sp['ID_PJ'];?>"
                                                            tabindex="-1" role="dialog"
                                                            aria-labelledby="exampleModalCenterTitle"
                                                            aria-hidden="true">
                                                            <div class="modal-dialog" role="document">
