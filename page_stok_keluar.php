    ...
    ?>
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-cart-plus"></i> Input Penjualan Pupuk
                  </h6>
...
$data = mysqli_query($conn, "SELECT ID_PK,Jenis_Pupuk,Harga,Stok FROM data_pupuk ORDER BY ID_PK DESC");
    ...
    ?>
                  ...
                  <div class="row mb-4">
                    ...
                    <div class="col-sm-4">
                      <input type="text" class="form-control" id="harga" name="harga" readonly required
                        onkeyup="priceManualControl()">
                    </div>
                    <div class="col-sm-4">
                      <div class="form-check form-check-inline mt-2">
                        <input class="form-check-input" type="checkbox" id="checkprice" value="option1" checked
                          onclick="priceControl()">
                  ...
                  <div class="row mb-4">
                    ...
                    <div class="col-sm-6">
                      <button type="button" id="btnOK" class="btn btn-primary btn-sm" onclick="addFields()"><i
                          class="fas fa-plus-square"></i> tambahkan</button>
                    </div>
                  </div>
