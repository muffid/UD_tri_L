                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-md font-weight-bold text-primary text-uppercase mb-1">
                                                   Piutang Aktif</div>
                                                    <div class="mb-0  text-gray-800">total</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?=rp($totalHutang-$totalDibayar)?></div>
                                            </div>
                                            <div class="col-auto">
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-md font-weight-bold text-primary text-uppercase mb-1">
                                                   Piutang Aktif</div>
                                                    <div class="mb-0  text-gray-800">total</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?=rp($totalHutangA-$totalDibayarA)?></div>
                                            </div>
                                            <div class="col-auto">
                                                <i class="fas fa-money-bill-wave fa-2x text-primary"></i>
                                            </div>
