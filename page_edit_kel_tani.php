            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between ">
                        <h1 class="h3 mb-3 text-gray-800">Kelompok Tani</h1>
                    </div>
                                    ...
                                    <form method="POST" action="editKelTani.php" enctype="multipart/form-data">
                                        ...
                                        <div class="row mb-6">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                <input name="NamaKel" type="text" class="form-control" id="NamaKel"
                                                    value="<?=$namaKel;?>" onkeypress="enbld()">
                                                <br>
                                            </div>
                                        </div>
                                        <div class="row mb-6">
                                            <label for="NamaKet" class="col-md-4 col-lg-3 col-form-label">Ketua
                                                Kelompok</label>
                                            <div class="col-md-8 col-lg-9">
                                                <input name="NamaKet" type="text" class="form-control" id="NamaKet"
                                                    value="<?=$namaKet;?>" onkeypress="enbld()">
                                                <br>
                                            </div>
                                        </div>
                                        <div class="row mb-6">
                                        ...
                                        <div class="row mb-6">
                                            ...
                                            <div class="col-md-8 col-lg-9">
                                                <textarea name="Alamat" id="Alamat" style="height: 100px"
                                                    class="form-control" onkeypress="enbld()"><?=$alamat;?></textarea>
                                                <br>
                                                <button id="fungsitombol" type="submit" name="fungsitombol"
